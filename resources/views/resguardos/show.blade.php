    ...
    <div class="rounded-lg shadow-md p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="border rounded-lg shadow p-4 space-y-6" style="background-color: #FFF9F2; color: #321F01;">
                ...
                <flux:input label="Asignado a" :value="$resguardo->asignado_nombre ?? 'No asignado'" readonly class="w-full" />
                <flux:input label="Colaborador" :value="$resguardo->colaborador_num" readonly class="w-full" />
                <flux:input label="Fecha de Resguardo" :value="\Carbon\Carbon::parse($resguardo->fecha_captura)->format('d/m/Y')" readonly class="w-full" />
            </div>
