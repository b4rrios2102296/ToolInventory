...
<div class="container mx-auto px-4 py-8">
    ...
    <form method="POST" action="{{ route('resguardos.update', $resguardo->folio) }}">
        ...
        <flux:button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-md">Actualizar</flux:button>
        <flux:button href="{{ route('resguardos.index') }}" class="px-6 py-2 bg-gray-500 text-white rounded-md">Cancelar</flux:button>
    </form>
</div>